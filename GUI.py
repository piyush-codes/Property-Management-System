...
def login_in():
	...
	login_menu.geometry("990x992")
	bg=Image.open("back.png")
	bg = bg.resize((login_menu.winfo_screenwidth(), login_menu.winfo_screenheight()))
	photo = ImageTk.PhotoImage(bg)
	bgl=Label(login_menu,image=photo)
	...
	subLabel=CTkLabel(frame, text="Anish Kumar, Piyush Singh and Tushar Prakash")
...
def register_in():
	...
	register_menu.geometry("990x992")
	
	bg=PhotoImage(file="back.png",height=990,width=992,master=register_menu)
...
def admin_in():
	...
	admin_menu.geometry("990x921")
	bg=PhotoImage(file="back.png",height=990,width=992,master=admin_menu)
...
def Admin_Opt():
	...
	opt_menu.geometry("990x992")
	bg=PhotoImage(file="back.png",height=900,width=992,master=opt_menu)
...
def add_book():
	...
	add_menu.geometry("990x992")
	bg=PhotoImage(file="back.png",height=990,width=992,master=add_menu)
...
def Main_Menu():
	...
	base.geometry("990x992")
	# image = Image.open('background.jpg')
	# image = image.resize((root.winfo_screenwidth(), root.winfo_screenheight()))
	bg=Image.open("back.png")
	bg = bg.resize((base.winfo_screenwidth(), base.winfo_screenheight()))
	photo = ImageTk.PhotoImage(bg)
	bgl=Label(base,image=photo)
	bgl.place(x=0,y=0,relwidth=1, relheight=1)
	...
	def reposition_frame(event):
		frame_width = 600
		frame_height = 400
		frame_x = (990 - frame_width) // 2
		frame_y = (992 - frame_height) // 2
		frame.place(x=frame_x, y=frame_y)
    
	base.bind("<Configure>", reposition_frame)
